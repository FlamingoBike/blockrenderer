...
var models = (function() {
	...
	var almostCube = new Model();
	almostCube.addCube(0, 0, 0, 1, 15/16, 1);
	...
	var fence = new Model();
	fence.addCube(0, 0, 3/8, 1/4, 1, 5/8);
	fence.addCube(3/4, 0, 3/8, 1, 1, 5/8);
	fence.addCube(-1/8, 13/16, 7/16, 9/8, 15/16, 9/16);
	fence.addCube(-1/8, 5/16, 7/16, 9/8, 7/16, 9/16);

	var wall = new Model();
	wall.addCube(1/4, 0, 1/4, 3/4, 1, 3/4);
	wall.addCube(0, 0, 5/16, 1, 13/16, 11/16);
